...
# python ic/main_tome.py --eval --load_compression_rate --data-path $path_to_imagenet$ --model ${CKT_SIZE}  --r 13 --ratio  0.9385 --use_k True

python ic/main_tome.py --eval --load_compression_rate --data-path $path_to_imagenet$ --model ${CKT_SIZE} --reduced_token 13 --ratio 0.925 --use_k True