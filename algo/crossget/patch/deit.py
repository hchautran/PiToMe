...
from .timm import CrossGetAttention, CrossGetBlock, CrossGetBlockUsingRatio
...
def apply_patch(
   model: VisionTransformer, trace_source: bool = False, prop_attn: bool = True, margin=0.9, use_k=False):
    ...
    margins = [.95 - .95*(i/num_layers) for i in range(num_layers)]
    ...
    for module in model.modules():
        if isinstance(module, Block):
            ...
            module.__class__ = CrossGetBlock if use_k else CrossGetBlockUsingRatio 
