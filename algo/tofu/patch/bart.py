...
# class ToFuBartEncoderLayer(BartEncoderLayer):
...
# class ToFuBartAttention(BartAttention):
...
# class ToFuBartEncoder(BartEncoder):
#     """
#     Modifications:
...
# def make_tofu_class(transformer_class:BartModel):
#     class ToFuBartModel(transformer_class):
#         def init_r(self):
...
#     """
#     ToFuBartModel = make_tofu_class(model.__class__)
#     print('using', 'tofu')

#     model.__class__ = ToFuBartModel
