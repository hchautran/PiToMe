...
import hashlib
from tasks.vqa.lmms_eval import evaluator, utils
from tasks.vqa.lmms_eval.tasks import initialize_tasks, include_path, get_task_dict
from tasks.vqa.lmms_eval.api.registry import ALL_TASKS
from tasks.vqa.lmms_eval.logging_utils import WandbLogger
from tasks.vqa.lmms_eval.utils import PathFormatter
