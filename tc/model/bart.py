...
class CompressedBartEncoder(BartEncoder, CompressedModel):
    def __init__(self, config): 
        super(self, CompressedBartEncoder).__init__(config)
        self.r = 0.9 
        self.compress_method = 'pitome' 
   ...
   r=0.9
    ...
    for module in model.modules():
        if isinstance(module, BartEncoder):
           print(module)
           module.__class__ = CompressedBartEncoder 
           module.compress_method = compress_method
           module.r = r
    return model
