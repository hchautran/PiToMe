...
PATH = '/home/caduser/HDD/vit_token_compress/PiToMe/sumarization/cnn_dailymail/url_lists'
all_train_urls = f"{PATH}/all_train.txt"
all_val_urls = f"{PATH}/all_val.txt"
all_test_urls = f"{PATH}/all_test.txt"
